...
- [x] 2.2.4 data attribute 와 dataset
- [x] 2.3 함께 보면 좋은 자료
...
- [x] 3.5.6 util
- [x] 3.6 파일 시스템 접근하기
- [x] 3.6.1 동기 메서드와 비동기 메서드
- [x] 3.6.2 버퍼와 스트림 이해하기
- [x] 3.6.3 기타 fs 메서드
- [x] 3.7 이벤트 이해하기
- [x] 3.8 예외 처리하기
- [x] 3.9 함께 보면 좋은 자료

4 장 http 모듈로 웹 서버 만들기
